...
def feat_extract_2(name):
	...
	w = codecs.open('features.csv', 'w', 'utf-8')
		...
		for word in words:
			...
			if word in dictionary:
				if dictionary[word] == 'v':
					v += 1
					v_wh += 1
				elif dictionary[word] == 'adj':
					adj += 1
					adj_wh += 1
				elif dictionary[word] == 'prep':
					prep += 1
					prep_wh += 1
				elif dictionary[word] == 'conj':
					conj += 1
					conj_wh += 1
				elif dictionary[word] == 'num':
					num += 1
					num_wh += 1
				elif dictionary[word] == 'adv':
					adv += 1
					adv_wh += 1
				elif dictionary[word] == 'pron':
					pron += 1
					pron_wh += 1
			...
			check_in(poss_pronouns, pron, pron_wh)

			# check postpositions
			check_in(postpositions, prep, prep_wh)

			# check reflexive pronoun
			check_in(reflexive_pronouns, pron, pron_wh)
...
feat_extract_2('.\\test_data\\test_text.txt')